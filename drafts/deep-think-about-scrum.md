...
久而久之，培育出了具备非常惊人的推卸责任能力的一群人，因为正好文档特别全面，不知不觉大家也都已经非常认真的整理好了出问题的时候“不管我的事情”的证据，反正只要不是我这儿掉链子就行。而且很多问题到最后才发现实际上是需求分析、设计阶段就已经错了，但往往我们是没有办法在中途提出这一点，因为牵扯到太多人的利益，所以为了日后的和气共事，也只能大家一起错到底。最后没有实现预期的价值，也还好，因为法不责众嘛。
...
有的时候你即使从岗位特性上，或者时间机遇上，具备了可以向用户提问题的条件，真正的答案也是未必能问出来。
...
敏捷方法中事实上也是杜绝文档形式的沟通的，而且需求文档是特意点名。

很多事情，只有通过对话形式，进行很多次的信息互换才能能够搞明白。
...
Scrumb中，为了确保需求是“真正的用户需求”，而是重量级方法中的用例需求或者别的其他东西，特意使用了新的词汇－用户故事。
...
[wikipedia](https://en.wikipedia.org/wiki/Scrum_(software_development)#Values)

- 交付: 团队成员在每一个迭代(Sprint)为了完成团队目标，独立地交付结果。
- 勇气: 团队成员清楚大伙是有勇气一起经历相互矛盾和相互挑战，去完成正确的事情。
...
那这些对企业有没有在收支上带来波动呢？硬掰，这也是说得过去的商业价值。

对于商业价值，我再举硬掰的几个例子。原因呢，还是这个。
>对每一个Story，都应该明确知道它的商业价值，哪怕你只能找到很牵强的联系。
...
如果你去找真实故事，去观察瓦特前前后后的处境，你会发现在他那个年代社会上已经有各式各样的蒸汽机了。
他是在这样的社会背景下，改良设计，使蒸汽机更佳符合生产需要。
...
电话确实是贝尔在实验过程中注意到了一种物理现象，并且基于它的原理发明出来的新生事物。

但在这背后，

你知道贝尔为了和当时许多闻到商机的发明家争夺先机，大部分时间都是自己偷偷做实验，小心翼翼地避免向他人透露自己的想法吗？

加德纳·格林·哈伯德，他是非常优秀的律师、马萨诸塞州的参议员，同时也是非常牛的商业精英。他作为贝尔的学生的家长，但也经历了很漫长时间的磨合，后面才会成为贝尔强有力的政治、经济上的后盾。为了在贝尔的发明中获利，他会利用职务便利，通过各种游说为后面贝尔公司的成立造势。

另外托马斯·桑德斯，也是贝尔学生的家长，是贝尔第一个经济后盾。哈伯德的加入贝尔甚至需要和这个人进行协商。
...
原子弹这种大规模杀伤性军事武器，看似和商业价值比较遥远。

但是，我相信你能够理解它的威慑力。对于一个国家，军事威慑力是这个国家任何商业团体能够安全生产，工人能够安全工作挣钱的保障。

国家也是以利润作为它的盛衰标杆。经济危机背后没落的国家又有多少呢？

假设，你有一颗原子弹，如果你有人身安全保证，你觉得你能不能卖出去它呢？它的价格，又是怎么来定呢？为何它能值钱呢？

#### 相对论

我们都知道至今即使基于著名的相对论，星际旅行还是幻想。

我在想，是不是因为在现实世界中这样的理论还没有让人们看到实际的商业价值，尚未能够聚集足够多的人力和财力有着联系。

>商业价值，我相信你一定能为自己的Story找到它们。

### <a name="h5.2">用户故事之头脑风暴</a><sup>[&#x2191;top](#top)</sup>

>头脑风暴是用户故事在Scrum中的正确姿势。

想到这个，我就会想到我们的义务教育。
无数次的考试使我们记住这种“事实”和“标准答案”，彻底把人类最宝贵的能力－好奇心扼杀在摇篮里。
培养出了无数的把迷信当知识的年轻人。

而头脑风暴过程恰恰特别需要这个能力-好奇心，能够想得到Why的能力。

Scrum中敏捷计划会议是第一站，也是最关键的环节。

按顺序，做三件事情。

1. 确定接下来的迭代(Sprint)中要完成的用户故事(User Story)和它们的商业价值。
2. 确定它们的优先级、大小。
3. 根据1和2的结论做合理调整。

要命的是1和2都是用头脑风暴的方法。

这是在这样一个整个业界都把效率挂在嘴边，略微浮夸的大环境里，最容易被人挑战的形式。

因为，“它效率低”。

有人第一次对于它的形式（头脑风暴形式的计划会议）质疑效率的时候，我也有同感，因为是事实。

Scrum方法论中计划会议也是摆在首要位置，也预计它可能会消耗掉一整天的时间，甚至有可能是两个完整的工作日。
...
它们不经过深思熟虑和多层次的抽象是形不成的，更不可能像我们所看到的那样得到广泛的认可。
...
能不能从社会当中最多数的，最普遍的价值认同感来解释？

什么是“最好”的？

“最好”的衡量是谁来做？应该由谁来做？

为什么辛普森一案中，与世隔绝的陪审团，在听取律师的陈述，了解了法庭证据之后，做出来的判断几乎出乎所有每天在媒体看新闻的人的预料？

这样的结局，究竟是好，还是坏？好与坏，谁来衡量？

为什么没有成文法典的，不依靠精英设计的习惯法的两个国家，一个英国，一个美国，不管是经济还是科学领域，都是世界的领先地位？

那么我们在日常的产品开发中，产品的好坏如何评判？应该有谁来做这个判断？衡量标准是什么？

我们能承认我们绝大多数人都没有乔布斯那种对人性深刻的洞察力吗？

我们能承认我们大部分时间判断产品好坏是用你、我、他的普世价值观来衡量的吗？

Scrum的计划会议中，我们事实上和陪审团一样，处在一个信息在一定程度上隔绝的局面中。

连一个几个人的团队都对产品的设计上，没有办法形成“不那么烂，还好”的认同，那把产品发布出去，在一个和团队成员差不多的价值观环境中去裸奔，它的命运会是什么样？

所以，在计划会议里的头脑风暴的技术操作难点在于，怎么样让大家把心里边那个“很烂”的感受和想法说出来，怎么样让大家一块来找让它“不那么烂”的方法。

最后达到一个平衡状态，这个状态就是“不错，还可以”。

这是对一个信息永远都不会那么全面的团队来讲，能得到“最好”结果的Scrum的方法。

再回到“效率低”的问题，如果说我们以头脑风暴的形式花费一或两个完整的工作日，来确定接下来2个星期或者4个星期里边可能都是最重要的那件事情，和省2天的草率的效率比起来，真不值得吗？

做最坏的打算，因为这种“低效率”，导致我们在接下来的2个或者4个星期里边，正因为少了那2个工作日，而没能完成最不重要的那一个或者两个故事，只能让它进入下一个迭代，我们是受益还是损失？

Scrum在现实中落地执行，有多少团队最终输出的产品是，团队成员所有人都认为还可以的？
...
计划会议中出现的迭代目标(Sprint Goal)，正是解这个题的key。

也因为这个原因，Sprint Goal原本应该是那么重要，但事实上我们是不是经常在跳过它?

前面说到Story的价值和重要性的判断是以头脑风暴的形式，确定故事的大小也同样是头脑风暴形式。

![](../images/CrispPlanningPokerDeck.jpg)

但这种形式有很重要的前提：

> 在对Story进行估算的时候没有假设的负责人，谁都不知道最终会有谁来完成它。

因为，只有任何人只有假设一件事情是自己做的前提下，才有可能非常认真的去考虑这件事情。

大家都在这个假设下，互相独立地去默默思考技术实现方案，并拆解步骤到可量化行动的粒度，才能够得出合理的估算结论。

大家同时摊开卡片的时候，所有人都会注意到估算最大和最小的那两张卡片。

之后，必定会有围绕着估算理由展开的头脑风暴形式的讨论，有的人可能觉得过度设计，有的人可能会觉得考虑的不够周全。

而软件产品，它的质量是最终让产品死亡的非常重要的原因之一，在质量上的妥协，尽管在短期来看是缩短了周期，但也会为将来的噩梦埋下伏笔。

而这种噩梦不只是开发者的，牵扯到整个团队的利益。

在这里，衡量技术方案到底好不好的标准，仍然是大家都认为不那么差的那个平衡点。而这，最后会以Story大小的形式反应在Sprint中。
